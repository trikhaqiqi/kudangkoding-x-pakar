                        ...
                        <div class="space-y-6">
                            ...
                            <div class="space-x-4">
                                <div class="inline-flex items-center">
                                    <input id="no" name="jawaban" type="radio" value="0"
                                        class="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-700" required>
                                    <label for="no" class="ml-2 block text-sm font-medium text-gray-700">
                                        {{ __('No') }}
                                    </label>
                                </div>
                                <div class="inline-flex items-center">
                                    <input id="yes" name="jawaban" type="radio" value="1"
                                        class="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-700" required>
