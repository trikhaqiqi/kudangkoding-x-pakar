        ...
        @else
            <div class="bg-white overflow-hidden shadow-md p-4 rounded-lg">
                <div class="w-7/12 space-y-4">
                    ...
                    <p>
                        {{ __('Kecemasan yang berlebihan, akan sulit dikendalikan, dan mengganggu aktivitas sehari-hari merupakan Gangguan Kecemasan. Dengan aplikasi dari Kudang Koding x Pakar, Anda dapat melakukan pengecekan terhadap kecemasan yang Anda alami') }}
                    </p>
                </div>
