        ...
        <section class="flex space-x-6">
            <div class="w-6/12 bg-white shadow-md rounded-lg px-4 py-6 space-y-8">
                ...
                @if ($user_history->result != '0' && $user_history->result !== '')
                    ...
                    <div class="space-y-6">
                        <p>
                            Dari hasil konsultasi berdasarkan dari gejala yang Anda alami, kecemasan Anda sama dengan
                            gejala <b>{{ $disease->name }}</b> sehingga diperlukan konsultasi lebih lanjut kepada
                            psikiater atau psikolog.
                        </p>
                        <p>
                            Untuk informasi lebih lanjut Anda dapat menghubungi <b>Direktorat Pencegahan dan
                                Pengendalian Masalah Kesehatan Mental dan Obat</b> di <b>119</b> atau <b>Kudang
                                Koding</b> di <b>+62 853 5122 1944</b>.
                        </p>
                    </div>
                ...
                @else
                    <div class="space-y-6">
                        <p>
                            Tidak ditemukannya indikasi mengenai gangguan kecemasan, sehingga tidak diperlukannya
                            konsultasi lebih lanjut kepada psikiater atau psikolog. Jika Anda ingin mengetahui lebih
                            lanjut seputar informasi gangguan kecemasan atau informasi kesehatan mental, Anda dapat
                            membaca beberapa artikel <a class="link font-bold">di
                                sini</a>
                        </p>
                        ...
                        <p>
                            Untuk informasi lebih lanjut Anda dapat menghubungi <b>Direktorat Pencegahan dan
                                Pengendalian Masalah Kesehatan Mental dan Obat</b> di <b>119</b> atau <b>Kudang
                                Koding x Pakar</b> di <b>+62 853 5122 1944</b>.
                        </p>
                    </div>
